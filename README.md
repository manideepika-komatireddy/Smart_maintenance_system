...
Smart_maintenance_system/ │ ├── app.py ├── maintenance.db ├── templates/ │ ├── index.html │ ├── add_machine.html │ ├── view_machines.html │ ├── add_sensor.html │ ├── view_logs.html │ └── dashboard.html │ └── screenshots/ ├── home.png ├── add_machine.png ├── view_machines.png ├── sensor_logs.png └── dashboard.png
